# Daytona Sandbox Orchestration Agent with Coder Agent

## How to Use Daytona with Coder

Follow these steps to run the multiagent demo with Daytona and Coder agents:
...
6. Go to the "Chat" page and enter this prompt:

```
Use coder to generate Python code that calculates the first 25 numbers of the Fibonacci sequence, then use Daytona to run it in a new sandbox.
```
